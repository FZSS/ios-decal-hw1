...
//: No, the variables ending with **!** are implicitly unwarrpped optionals, they cannot be **nil**. But the variables ending with **?** could be **nil**.
...
//: Because declaring a variable with **let** making it an immutable constant. This function also does not return **true** at the end. Also, the function should be static, because it is not called on a instance.
...
//: The instantiation is incorrect. The final return value should be **true** for a **bool** type. Also, this function should not be a class function, because it uses instance variables, e.g. self.wordA. Meanwhle, letA, letB could be constant, letter could be replaced with _.
